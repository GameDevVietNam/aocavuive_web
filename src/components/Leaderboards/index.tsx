...
const Leaderboards = () => {
	...
	return (
		<div className='space-y-4'>
			<div className='text-xl font-semibold'>Leader boards</div>

			<div className='flex items-center gap-3 flex-nowrap overflow-x-scroll no-scrollbar'>
				<Button>
					<Image
			...
			<div className='p-4 bg-semidark rounded-2xl space-y-1'>
